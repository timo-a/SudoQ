...
<2017-05-07> solved a bug at actionTree where 4times tap on a symbol would crash the app.
             found new bug:
              ...
              also continue after update, crashed the app . test before release!
on the horizon:
 - extract clock functionality into toolbar
 - understand file/profile manager to get unit tests back running

generator - mock up test external
editor branch
language branch
