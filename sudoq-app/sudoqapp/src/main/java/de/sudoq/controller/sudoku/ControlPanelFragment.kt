...
class ControlPanelFragment : Fragment() {
    private var activity: SudokuActivity? = null
    ...
    fun onClick(v: View) {
        ...
        val mediator = activity.getMediator()
    ...
    private val controlPanel: View
        private get() {
            val conf = resources.configuration
            val portraitLeft = conf.orientation == Configuration.ORIENTATION_PORTRAIT && game!!.isLefthandedModeActive
            return activity!!.findViewById(if (portraitLeft) R.id.controlPanelLeft //sl.find... doesn't seem to work
            else R.id.controlPanel)
        }
