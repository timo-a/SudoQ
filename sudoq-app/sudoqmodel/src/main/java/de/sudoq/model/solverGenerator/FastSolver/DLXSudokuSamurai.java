...
import de.sudoq.external.dlx.DancingLinks;
import de.sudoq.external.dlx.FastSudokuHandler;
import de.sudoq.external.dlx.SamuraiSudokuHandler;
...
public class DLXSudokuSamurai extends AbstractSudokuSolver {
    ...
    private int[][] sudokuExactCover(){
        ...
        hBase = setBlock(R, hBase, 6,9);
        hBase = setBlock(R, hBase, 9,6);
        hBase = setBlock(R, hBase, 9,9);
        hBase = setBlock(R, hBase, 9,12);
        hBase = setBlock(R, hBase, 12,9);*/
