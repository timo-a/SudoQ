...
internal class SolverRegressionTests {
    ...
    fun regression1on9x9() {
        ...
        val s = SudokuMockUps.stringTo9x9Sudoku(r2)
        val solver = Solver(s)

        solver.solveAll(true, false, false)
        println(solver.solutions)
        println(solver.hintCountString)
    }

    @Test
    fun samurai1() {
        val pattern = (". 7 . . . 2 0 . 8       . 5 . . . . 3 . . "
        ...
        val s = SudokuMockUps.stringToSamuraiSudoku(SudokuMockUps.increase9By1(pattern))
        val solver = Solver(s)
        solver.solveAll(true, false, false) `should be` true
    }

    @Test
    fun samurai1MoreSolutions() {
        val pattern = ("4 7 1 . . 2 0 3 8       7 5 8 1 0 6 3 4 2 "
        ...
        */
        ...
        solver.getSolverSudoku().getCurrentCandidates(Position[8, 10]).clear(3)

        solver.solveAll(true, false, true) `should be` true
    }


    @Test
    fun samurai1SubBoardA() {
        val pattern = (". 7 . . . 2 0 . 8 "
                + "5 0 . 8 . 3 7 . . "
                + "3 8 6 . 0 . . . 5 "
                + "2 4 3 . 1 . . . . "
        ...
        val s = SudokuMockUps.stringTo9x9Sudoku(SudokuMockUps.increase9By1(pattern))
        val solver = Solver(s)
        solver.solveAll(true, false, false) `should be` true
    }
